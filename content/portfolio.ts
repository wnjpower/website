...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    isPlaceholder: true,
    summary:
      '경북 칠곡 공장 현장 규격에 맞춘 배전반·분전반을 자체 제작해 납품·설치했습니다. 외주 없이 직접 제작해 중간 마진이 발생하지 않습니다.',
    scopeItems: [
      '현장 부하 산정 및 반 규격 설계',
      '외함 제작 및 기기 배치',
      '부스바·내부 결선 작업',
    ...
    challenge:
      '배전반은 기성품을 쓰면 현장 회로 수나 설치 공간과 맞지 않는 경우가 많습니다. 회로가 남거나 모자라면 이후 증설 때마다 반을 다시 손봐야 합니다. 제작 단계에서 현재 부하뿐 아니라 향후 증설분까지 감안해 예비 회로와 내부 여유 공간을 확보해 두면, 나중에 반 교체 없이 차단기 추가만으로 대응할 수 있습니다.',
    work: [
      '현장 실측 및 부하 계산',
      '반 규격·기기 배치 설계 확정',
      '외함 제작 및 기기 취부',

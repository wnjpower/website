import { Factory, CircuitBoard, PhoneCall } from 'lucide-react';

const items = [
  {
    icon: Factory,
    title: '공장·산업 전기 원스톱',
    description: '공장 신축·증축·증설부터 수전설비·계약전력 증설·동력설비·배전반 제작까지 한 업체에서. 설계 검토부터 준공까지 협력업체 조율 없이 직접 시공합니다.',
    tags: ['공장', '산업시설', '물류센터'],
  },
  {
    icon: CircuitBoard,
    title: '배전반·분전반 자체 제작',
    description: '외주 없이 직접 제작하므로 중간 마진이 없습니다. 현장 규격·회로 수에 맞는 산업용 배전반·분전반을 합리적인 가격에 공급하고, 납기도 빠릅니다.',
    tags: ['공장', '상업건물', '상가', '주택'],
  },
  {
    icon: PhoneCall,
    title: '신속한 A/S',
    description: '대구·경북 지역 전담으로 문제 발생 시 당일 출동 원칙. 공장 준공 후, 가게 오픈 후, 건물 준공 후에도 사후관리까지 책임집니다.',
    tags: ['공장', '상업건물', '주택·상가'],
  },
];
